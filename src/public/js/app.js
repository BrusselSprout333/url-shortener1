...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      var url = this.fields.url;

      if (regex.test(url)) {
        axios.post('/api/encode', this.fields).then(function (response) {
          ...
          _this.success = true;
          _this.error = null;
          _this.shortcutUrl = response.data.url;
...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('hash-create', (__webpack_require__(/*! ./views/app.vue */ "./resources/js/views/app.vue")["default"]));
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "form__item" }, [
          _c(
            "label",
            { staticClass: "form__item-label", attrs: { for: "url" } },
            [_vm._v("Your URL")]
          ),
          _vm._v(" "),
          _c("input", {
            ...
            on: {
              input: function ($event) {
                ...
                _vm.$set(_vm.fields, "url", $event.target.value)
              },
            },
          }),
        ]),
        ...
        _c("div", { staticClass: "form__item" }, [
          _c(
            "button",
            {
              ...
              staticClass: "form__item-btn cut",
              attrs: { type: "button" },
          ...
          _c(
            "button",
            { staticClass: "form__item-btn copy", attrs: { type: "submit" } },
            [_vm._v("Cut URL")]
          ),
        ]),
        _vm._v(" "),
        _c(
          ...
          [
            _c(
              "label",
              { staticClass: "form__item-label", attrs: { for: "shortURl" } },
              [_vm._v("Your shortcut url")]
            ),
            _vm._v(" "),
            _vm.shortcutUrl
              ? _c("input", {
                  ...
                  domProps: { value: _vm.shortcutUrl },
                })
              : _vm._e(),
          ]
        ),
